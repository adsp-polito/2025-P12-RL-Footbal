"""
Multi-agent what-if training settings for football tactical AI
...
multiagent_params = {
    ...
    "paths": {
        "rewards_dir": "src/football_tactical_ai/training/rewards/whatIF",              
        "save_model_path": "src/football_tactical_ai/training/models/whatIFModel",               
        "save_render_dir": "src/football_tactical_ai/training/renders/whatIF"
    },
