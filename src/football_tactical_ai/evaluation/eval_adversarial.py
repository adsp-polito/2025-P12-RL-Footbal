...
def evaluate_multi(scenario="2v1"):
    """
    Evaluate a trained multi-agent PPO model (RLlib) over predefined 2v1 test cases.
    ...
    # Override max_steps for evaluation: 30 seconds
    max_steps = fps * 30

    # model_path = "/Users/arvin/arvinDoc/PoliTo/2025-2026-1/adsp/footballAI-ads/src/football_tactical_ai/training/models/multiAgentModel"      # IMPORTANT: must be a RLlib checkpoint directory (absolute path)
    # model_path = "/Users/arvin/arvinDoc/PoliTo/2025-2026-1/adsp/footballAI-ads/src/football_tactical_ai/training/models/adversarial_attacker/final"
    model_path = "/Users/arvin/arvinDoc/PoliTo/2025-2026-1/adsp/footballAI-ads/src/football_tactical_ai/training/models/adversarial_attacker/cycle_11"
