...
def render_state(state, pitch, ax=None, stripes=False, full_pitch=False,
    ...
    if full_pitch:
        ax = pitch.draw_pitch(ax=ax, stripes=stripes,
                              show_grid=show_grid,
                              show_heatmap=show_heatmap,
                              show_rewards=show_rewards,
                              env=env)
    else:
        ax = pitch.draw_half_pitch(ax=ax, stripes=stripes,
                                   show_grid=show_grid,
                                   show_heatmap=show_heatmap,
                                   show_rewards=show_rewards,
                                   env=env)
